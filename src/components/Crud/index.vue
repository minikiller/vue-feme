      ...
      <template v-for="(key, index) in Object.keys(columns)">
        <el-table-column
          ...
          v-if="
            key in fields &&
            fields[key].options &&
            fields[key].formatter &&
            typeof fields[key].formatter === 'function'
          "
          :label="columns[key]"
        ...
        >
          ...
          >
            <el-option
              ...
              :disabled="
                fields[key].unique &&
                repeated(key, o.value, (updatingRow || '')[key])
              "
            />
          </el-select>
          <el-date-picker
          ...
          <el-input
            :disabled="fields[key].disabled"
            v-else-if="
              fields[key].type === TYPES.integer ||
              fields[key].type === TYPES.float
            "
            type="number"
